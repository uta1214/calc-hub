...
3. Type `ext install calchub`
4. Press Enter

Or search for "CalcHub" in the Extensions view (`Ctrl+Shift+X` / Mac: `Cmd+Shift+X`).

## Usage

### Basic Calculation
1. Open the CalcHub sidebar panel
...
No configuration required — CalcHub works out of the box.
...
3. `ext install calchub` と入力
4. Enterを押す

または拡張機能ビュー (`Ctrl+Shift+X` / Mac: `Cmd+Shift+X`) で「CalcHub」を検索。

## 使い方

### 基本計算
1. CalcHubサイドバーパネルを開く
